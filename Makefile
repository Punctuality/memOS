...
# Kernel
target/memmap_count.o: boot/detect_memory.asm
	$(ASM) $< -f elf32 -o $@
...
kernel_targets: target/memmap_count.o target/memmap.o target/memory.o target/util.o target/shell.o target/kernel.o

# Finalize

target/kernel.bin: target/kernel_entry.o target/screen.o target/idt.o target/keyboard.o target/util.o target/memmap_count.o target/memmap.o target/memory.o target/shell.o target/kernel.o target/io_functions.o
